 ...
 local menu251bd8143891238ecedc306508e29017 = {
     {"Darkplaces", "darkplaces-sdl", "/usr/share/icons/hicolor/16x16/apps/darkplaces.png" },
     {"Darkplaces mod", "darkplaces-sdl -game dpmod", "/usr/share/icons/hicolor/16x16/apps/darkplaces.png" },
 ...
 local menuee69799670a33f75d45c57d1d1cd0ab3 = {
     ...
     {"Thunar File Manager", "thunar ", "/usr/share/icons/gnome/16x16/apps/system-file-manager.png" },
